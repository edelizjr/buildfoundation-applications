...
@Configuration
@EnableR2dbcRepositories({ "com.roboticreg.buildfoundation.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("com.roboticreg.buildfoundation.repository.search")
